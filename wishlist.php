                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                  ...
                                  <span class="breadcrumb-item active">Lista e deshirave</span>
                                </nav>
                            </div>
                        </div>
                    </div>
                        ...
                        <form action="#">               
                            <div class="table-content table-responsive">
                                <table>
                                    <thead>
                                        <tr>
                                            <th class="product-thumbnail">Produktet</th>
                                            <th class="product-name">Emri i produkteve</th>
                                            <th class="product-remove">Fshi</th>
                                        </tr>
                                    </thead>
                                    <tbody>
										<?php
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="buttons-cart--inner">
                                        <div class="buttons-cart">
                                            <a href="<?php echo SITE_PATH?>">Vazhdo shoppingun</a>
                                        </div>
                                        <div class="buttons-cart checkout--btn">
                                            <a href="<?php echo SITE_PATH?>checkout.php">Kontrollo</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
