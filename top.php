...
$meta_title="SHTEPIA E BEBES";
$meta_desc="SHTEPIA E BEBES";
$meta_keyword="SHTEPIA E BEBES";
                    ...
                    <div class="row">
                        <div class="menumenu__container clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-4"> 
                                <div class="logo">
                                     <a href="index.php"><img src="images/logoDyqani.png" alt="logo images" ></a>
                                </div>
                            </div>
                            <div class="col-md-5 col-lg-6 col-sm-5 col-xs-3">
                                <nav class="main__menu__nav hidden-xs hidden-sm">
                                    <ul class="main__menu">
                                        <li class="drop"><a href="index.php">Menuja kryesore</a></li>
                                            <?php 
                                ...
                                <div class="mobile-menu clearfix visible-xs visible-sm">
                                    <nav id="mobile_dropdown">
                                        <ul>
                                            <li><a href="index.php">Menuja kryesore</a></li>
                                            <?php 
                                                foreach($cat_arr as $list){
                                                ?>
                                            ...
                                            ?>
                                            <li><a href="contact.php">Kontakt</a></li>
                                            <li><a href="my_order.php">Porosi</a></li>
                                                ...
                                                <ul class="navbar-nav mr-auto">
                                                  <li class="nav-item dropdown">
                                                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
                                                     C'kemi <?php echo $_SESSION['USER_NAME'] ?>
                                                    </a>
                                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                      <a class="dropdown-item" href="my_order.php">Porosite </a>
