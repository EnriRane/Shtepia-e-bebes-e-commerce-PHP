	...
	if($check>0){
		if(isset($_GET['id']) && $_GET['id']!=''){
			...
			if($id==$getData['id']){
				...
				$msg="Nen kategoria tashme ekziston";
			}
		}else{
			$msg="Nen kategoria tashme ekziston";
		}
...
<div class="content pb-0">
            <div class="animated fadeIn">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card">
                        <div class="card-header"><strong>Nen kategoria</strong><small> Form</small></div>
                        <form method="post">
							<div class="card-body card-block">
							   <div class="form-group">
								...
								<div class="form-group">
									...
									<input type="text" name="sub_categories" placeholder="Vendos nen kategorine" class="form-control" required value="<?php echo $sub_categories?>">
								</div>
