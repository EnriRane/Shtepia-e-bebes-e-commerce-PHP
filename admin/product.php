   ...
   <div class="orders">
      <div class="row">
        <div class="col-xl-12">
          <div class="card">
            <div class="card-body">
               <h4 class="box-title">Produktet </h4>
               <button type="button" class="btn btn-primary" style="margin-top: 5px;"><a href="manage_product.php" style="color: white;">Shto Produkt</a></button>
            </div>
            <div class="card-body--">
                 ...
                 <table class="table ">
                   <thead>
                     <tr>
                        ...
                        <th>Emri</th>
                        <th>Foto</th>
                        <th>Cmimi maksimal i shitjes</th>
                        <th>Cmimi</th>
                        <th>Sasia</th>
                        <th></th>
                     </tr>
                     ...
                     <tr>
                        ...
                        <td><?php echo $row['qty']?><br>
                          <?php
                           ...
                           ?>
                            Sasia tani: <?php echo $pneding_qty?>
                        </td>
                        <td>
                        <?php
                        if($row['status']==1){
                        ...
                        echo "<span class='badge badge-edit'><a href='manage_product.php?id=".$row['id']."'>Edito</a></span>&nbsp;";
