	...
	<div class="orders">
	   <div class="row">
		  <div class="col-xl-12">
			 <div class="card">
				<div class="card-body">
				   <h4 class="box-title">Kuponi </h4>
				   <button type="button" class="btn btn-primary" style="margin-top: 5px;"><a href="manage_coupon_master.php" style="color: white;">Shto kupon</a></button>
				</div>
				<div class="card-body--">
					  ...
					  <table class="table ">
						 <thead>
							<tr>
							   <th class="serial">#</th>
							   <th width="2%">ID</th>
							   <th width="20%">Kodi i kuponit</th>
							   <th width="20%">Vlera e kuponit</th>
							   <th width="20%">Lloji i kuponit</th>
							   <th width="10%">Vlera minimale</th>
							   <th width="26%"></th>
							</tr>
						 </thead>
						 <tbody>
							...
							<tr>
							   ...
							   <td>
								...
								echo "<span class='badge badge-edit'><a href='manage_coupon_master.php?id=".$row['id']."'>Edito</a></span>&nbsp;";
