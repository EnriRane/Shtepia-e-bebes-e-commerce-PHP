...
function send_message() {
  ...
  if (name == "") {
    ...
    alert("Ju lutem vendosni numrin e telefonit...");
  } else if (message == "") {
    ...
    jQuery.ajax({
      ...
      success: function (result) {
        ...
        if (result == "Thank you") {
          alert("Mesazhi u dergua me sukses!");
          jQuery(".register_msg p").html("Thank you for message");
          jQuery("#contact-form")[0].reset();
        }
        //alert(result).reset('#contact-form');
      },
    });
  }
  alert("Mesazhi u dergua me sukses!");
...
function user_register() {
  ...
  if (mobile == "") {
    jQuery("#mobile_error").html("Ju lutem vendosni numrin e telefonit");
    is_error = "yes";
  }
  if (password == "") {
    jQuery("#password_error").html("Ju lutem vendosni passwordin");
    is_error = "yes";
  }
  if (is_error == "") {
    jQuery.ajax({
...
function user_login() {
  ...
  if (password == "") {
    jQuery("#login_password_error").html("Ju lutem vendisni passwordin!");
    is_error = "yes";
  }
  if (is_error == "") {
    jQuery.ajax({
  ...
  jQuery.ajax({
    ...
    success: function (result) {
      ...
      if (result == "not_avaliable") {
        alert("Kjo sasi nuk eshte e vlefshme");
      } else {
